...
const TaskService = {
     ...
     * @returns
     */
    createTask: function (taskParams, name) {
        var _a;
     ...
     * @returns
     */
    constructTask: (title, description, priority, dueDate, taskComments, existingUser) => {
        var _a, _b, _c;
     ...
     * @returns
     */
    filterTask: (tasks, filterParam, filterParamValue) => {
     ...
     * @returns
     */
    fetchTaskBasedOnPagination: (tasks, page, limit) => {
     ...
     * @param res
     */
    updateTask: (name, taskId, updatedTasks) => {
